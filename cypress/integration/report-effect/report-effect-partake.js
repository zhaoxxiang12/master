import { activeSelect, clickListener, formatPrecision, interceptAll, validatePdfFile, waitIntercept } from '../../shared/util'
import { clickSearch, inputSearch, clickHeaderCell, checkRadio, openProvince, clickTool, openTagSelect, checkDisplayFields, validCclChecked, validPrint, validCellText } from '../../shared/effect-query'
context('参与实验室情况', () => {
  ...
  const queryPartake = () => {
    return interceptAll('service/mgr/evaReport/joinLab?*', 'queryPartake')
  }
  ...
  const validData = (data) => {
    ...
    expect(totalRate, '总参与率为100').to.equal(1)
