context('互认标准设置', () => {
    ...
    //         //点击合格判定规则  下拉框       
    //         cy.get('input[placeholder="合格判定规则"]').click({
    //             force: true
    //         })
    //         //CV%判定规则选择
    ...
    //     })
    // })
    // it('cqb-001-互认标准设置-添加标准-新增标准名称已存在失败', () => {
    //     let typeName = "佛山标准"
    //     let standardName = 1
    //     let saveButton = 7
    //     cy.visit('/cqb-base-mgr-fe/app.html#/setting/mutual-result/mutual-standard')
    ...
    //     })
    // })
    // it('cqb-001-互认标准设置-添加标准-标准名称为空保存失败', () => {
    //     let saveButton = 7
    //     cy.visit('/cqb-base-mgr-fe/app.html#/setting/mutual-result/mutual-standard')
    //     cy.get('.sd-cfg').find('.el-card.sd-cfg__item.is-hover-shadow').then((getData) => {
    //         let getLength = getData.length
    ...
    //     cy.get('body').should('contain', '保存成功！')
    // })
    // it('cqb-0119-互认标准设置-阈值标准未填写不能保存', () => {
    //     let COV2 = 1
    //     let edit = 1
    //     let setRules = 1
    //     let saveButton = 9
    ...
    // })
    // it('cqb-0119-互认标准设置-连续合格月数未填写不能保存', () => {
    //     let COV2 = 1
    //     let edit = 1
    //     let setRules = 1
    //     let saveButton = 9
    ...
    // })
    // it('cqb-0119-互认标准设置-CV%判定规则未填写不能保存', () => {
    //     let COV2 = 1
    //     let edit = 1
    //     let setRules = 1
    //     let saveButton = 9
    ...
    // })
    // it('cqb-0119-互认标准设置-阈值填写不规范(负数大于100，0，特殊符号)不能保存', () => {
    //     let COV2 = 1
    //     let edit = 1
    //     let setRules = 1
    //     let saveButton = 9
    ...
    //             force: true
    //         })
    //         cy.get('.el-input__inner').eq(typeBox).clear().type('自动化测试修改模板名称', {
    //             force: true
    //         })
    //         cy.get('.el-button.el-button--primary.el-button--medium').eq(saveButton).click({
    //             force: true
    //         })
    //         cy.get('.el-table__body').eq(miniList).find('.el-table__row').eq(getLength - 1).find(".cell").eq(demoName).should('have.text', '自动化测试修改模板名称')
    //         cy.get('body').should('contain', '保存成功！')
    //     })
    // })
    // it('cqb-0119-互认标准设置-使用模板', () => {
    //     let chemical = 2
    //     let edit = 1
    //     let setRules = 1
    //     let checkTest = 24
    ...
    // })
    // it('cqb-0119-互认标准设置-已关联标准的实验室不能再次关联(复选框置灰)', () => {
    //     let chemical = 2
    //     let edit = 1
    //     let typeBox = 0
    //     let checkBox = 24
