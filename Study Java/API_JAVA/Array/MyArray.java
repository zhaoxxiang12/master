...
public class MyArray {
    ...
    private String[] array; // 自定义数组   自定义数组底层的构建数组

    public MyArray() {
        super();
        capacity = default_capacity;
        array = new String[default_capacity];// 无参创建出的自定义数组长度就是10
    }
...
//            System.out.println("数组长度为"+array.length);
     ...
     * @return 被删除的元素
     */
    public String remove(int index) { //被删除元素后的元素会整体向前移动
        rangeCheck(index);
        String deleteObj = array[index]; // 即将要删除的元素
