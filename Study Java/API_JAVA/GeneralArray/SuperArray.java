...
public class SuperArray<T> {
    ...
    private T[] array; // 自定义数组   自定义数组底层的构建数组

    public SuperArray() {
        super();
        capacity = default_capacity;
        array = (T[]) new Object[default_capacity];// 无参创建出的自定义数组长度就是10
    }

    public SuperArray(int capacity) {
        super();
        this.capacity = capacity;
        array =(T[]) new String[capacity];
    }
...
//            System.out.println("数组长度为"+array.length);
     ...
     * @return
     */
    public String updateArray(int index, T value) {
